...
export async function GET(
  ...
  try {
    ...
    const birthTimeRaw = row.birth_time;
    const latitude = Number(row.birth_latitude);
    const longitude = Number(row.birth_longitude);
    const timezone = row.birth_timezone || 'UTC';
