...
ОБЯЗАТЕЛЬНОЕ ПРАВИЛО: Каждый астрологический термин сразу поясняй простым языком. Например: "Меркурий в квадратуре к Марсу — проще говоря, слова сегодня звучат резче, чем вы имеете в виду." Термин + тире + что это значит для обычного человека.
