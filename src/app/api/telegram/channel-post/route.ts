...
Объём: 2 коротких абзаца, 100-140 слов. Не больше.
...
- "При этом", "Кстати", "Кроме того", "Более того", "Стоит отметить"
- Слово "наполнен" в любом контексте
- Перечисление всех аспектов подряд. Выбери 2-3 самых важных, остальные пропусти
- Одинаковая длина предложений. Чередуй: короткое. Потом подлиннее. Опять короткое.

КАК ОБЪЯСНЯТЬ ТЕРМИНЫ: Не через определения, а через ощущения. Вместо "оппозиция — напряжённый аспект" пиши "Луна спорит с Марсом, и вы это почувствуете: захочется и выделиться, и чтобы оставили в покое."
