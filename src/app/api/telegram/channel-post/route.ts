...
КАК ОБЪЯСНЯТЬ: Каждый астрологический термин сразу поясняй простым языком. Можно использовать "это значит, что" или тире для пояснений, но не злоупотребляй одной и той же конструкцией. Варьируй способы объяснения. Давай конкретные, практические советы (что делать, чего избегать).

СИНТЕЗ: В конце поста сведи все влияния в одну ясную картину дня. 1-2 предложения, которые отвечают: "Какой это день в целом?" Не обобщай до банальности, сохрани нюансы, но дай ясный итог. Читатель должен закрыть пост с пониманием общего настроения дня.

ЗАПРЕЩЕНО:
- Театральные метафоры ("эмоции искрят как оголённый провод", "логику можно выключать")
- Излишняя персонификация планет (планеты не "воркуют", не "обнимаются", не "шепчутся")
- Фамильярный тон ("как спалось?", "кофе варится лениво")
